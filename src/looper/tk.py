...
solo_led.grid(column=7, row=0)

loop_count = Label(text=0, bg="gray")
loop_count.grid(column=5, row=0)

loop_num = Label(text=0, bg="gray")
loop_num.grid(column=6, row=0)
